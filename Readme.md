...
├── Prompt Outlines/                # Prompt outlines for PerGent agents & baselines
│   └── ...
...
├── Human Calibration of LLM Judge/        # Calibration process of LLM-as-Judge evaluation done by human experts
│   └── ...
└── Readme.md                       # This file
```
...
The [`Prompt Outlines/`](Prompt%20Outlines/) directory contains the prompt outlines used by:
...
### Human Calibration of LLM Judge

The [`Human Calibration of LLM Judge/`](Supplementary%20Materials/) directory includes:
