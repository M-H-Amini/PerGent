...
| [`Prompt Outlines/`](Prompt%20Outlines/)                 | Contains the prompt outlines used in the **PerGent** agentic pipeline and the baseline approaches described in the paper.           |
